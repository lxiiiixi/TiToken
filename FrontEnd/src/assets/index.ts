...
export { default as BlueCard } from "@/assets/background/BlueCard.png";
export { default as GreenCard } from "@/assets/background/GreenCard.png";
export { default as OrangeCard } from "@/assets/background/OrangeCard.png";
export { default as PurpleCard } from "@/assets/background/PurpleCard.png";
export { default as RoseCard } from "@/assets/background/RoseCard.png";

export { default as BlueCardH5 } from "@/assets/background/BlueCardH5.png";
export { default as GreenCardH5 } from "@/assets/background/GreenCardH5.png";
export { default as OrangeCardH5 } from "@/assets/background/OrangeCardH5.png";
export { default as PurpleCardH5 } from "@/assets/background/PurpleCardH5.png";
